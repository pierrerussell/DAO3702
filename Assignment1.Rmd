...
plot(email_graph, main = "Basic Network Diagram")

deg <- degree(email_graph)
plot(email_graph, vertex.label = NA, vertex.size = sqrt(deg) * 3,
     edge.width = 0.5, main = "Improved Network Diagram")
```

The improved version removes labels and sizes nodes by how connected they are, enhancing readability and interpretability.
